...
class Connexion {
    ...
    static private $database = 'saes3-mjahier'; // votre id court
    static private $login ='saes3-mjahier'; // votre id court
    static private $password = 'A60qCz74cFjMQDPY'; // votre mdp
